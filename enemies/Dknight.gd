...
var attacking = false
var ready = true
var general_delay = 0.65

var flip_tired_delay = 0.2
...
var attack_recover_time = 1.65
var attack_range = 70
var attack_trigger = 140
export var reach = 330
var dir
...
func _physics_process(_delta):
	...
	if (target != null):
		...
		if (attacking):
			#velocity.x = 0
			if (d > attack_range and d < reach and !hitting):
				velocity.x = abs(position.x - player.position.x) * 3
