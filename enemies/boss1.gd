...
onready var bullet = preload("res://enemies/Projectiles/boss1_ball.tscn")
...
func _on_Shoot_timeout():
	...
	if state == SHOOTING or (boss and d > 170 and d < RANGE):
		shooting = true
